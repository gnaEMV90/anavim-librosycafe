  ...
  gallery: [
    {
      ...
      text: 'Biblias, devocionales y literatura cristiana para grandes y chicos, con opciones pensadas para regalar o acompañar la lectura diaria.',
      labels: ['Biblias', 'Devocionales', 'Literatura', 'Regalo'],
      url: 'https://www.instagram.com/reel/DORLhvmjpOv/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==',
    },
    {
      tag: 'Café de especialidad',
      type: 'Reel',
      title: 'Café de especialidad, en ANAVIM',
      ...
      labels: ['Café', 'Colombia', 'Etiopía', 'Tanzania'],
